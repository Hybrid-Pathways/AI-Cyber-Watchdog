        ...
        messages=[
            {
                ...
                'content': f'Here is a report from Shodan: {shodan_report}. Given your expertise as Security Analyst , provide a summary of this report with the folowing requirements:'
                           ...
                           f'2. For all Operating Systems detected or provided from CMDB(using the "Operating System:" field in the report, ubuntu and windows very common), along with CVE information, provide a list of services running on open ports. If ssh is detected, provide all applicable CVEs and CVSS scores.'
